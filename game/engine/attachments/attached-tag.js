...
export default class Attached extends Tag{
  static tagType = 'Attached'
    ...
    syncPosition() {
      ...
      let rotationAngleRadians = attachedToEntity.getComponent('PositionComponent').angleDegrees * Math.PI / 180;
    ...
    syncAngleDegrees() {
      let attachmentOptions = this.entity.getComponent('AttachedComponent').attachmentOptions
      let attachedToEntity = this.entity.getComponent('AttachedComponent').attachedToEntity;
      let angleDegrees = attachedToEntity.getComponent('PositionComponent').angleDegrees
      this.entity.getComponent('PositionComponent').angleDegrees = angleDegrees + (attachmentOptions.angleDegrees || 0)
    }
  }
