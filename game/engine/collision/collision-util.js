...
export const isCircleCollidingWithRotatedRect = (circle, rect) => {
    // Rotate circle into rectangle's local space (invert rect rotation)
    ...
    // Clamp circle center to rectangle bounds in local space
    ...
    // Compute distance to clamped point
