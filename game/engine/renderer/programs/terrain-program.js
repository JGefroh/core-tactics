...
import { default as terrainFragmentShaderSourceCode } from '@game/engine/renderer/shaders/terrain-fragment-shader';
import { default as terrainVertexShaderSourceCode } from '@game/engine/renderer/shaders/terrain-vertex-shader';
...
class Program extends BaseProgram {
  ...
  uploadInstanceData(commands) {
    ...
    _flushInstanceDataBuffer(renderCtx, perFrameCache) {
      ...
      renderCtx.blendFunc(renderCtx.ONE, renderCtx.ONE_MINUS_SRC_ALPHA);
    ...
    _initializeProgram(renderCtx) {
      this.program = this._initializeProgramGeneric(
        renderCtx, 
        terrainVertexShaderSourceCode, 
        terrainFragmentShaderSourceCode, 
