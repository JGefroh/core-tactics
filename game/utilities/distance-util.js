...
export let distanceBetweenEntities = (entity1, entity2) => {
    let entityXPosition = entity1.getComponent('PositionComponent').xPosition;
    let entityYPosition = entity1.getComponent('PositionComponent').yPosition;
    let targetXPosition = entity2.getComponent('PositionComponent').xPosition;
    let targetYPosition = entity2.getComponent('PositionComponent').yPosition;

    return distanceFromTo(entityXPosition, entityYPosition, targetXPosition, targetYPosition)
}